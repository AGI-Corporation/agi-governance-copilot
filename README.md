...
This project is the **first reference implementation** of the [AGI Future Foundation PBC](https://www.agifuturefoundation.org)'s Institutional AGI governance architecture, translated into a working agentic stack using OpenClaw.

It helps decentralized organizations:
...
PRs welcome. See [docs/architecture.md](docs/architecture.md) to understand the design.
All contributions must maintain the advisory-only safety model and open governance ledger.
